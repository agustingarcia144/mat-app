        ...
        <CardContent className='space-y-6 text-base leading-7 text-zinc-800 dark:text-zinc-100'>
          <section className='space-y-2'>
            ...
            <ol className='list-decimal space-y-1 pl-5'>
              ...
              <li>
                Use the subject: <span className='font-medium'>Delete my account</span>.
              </li>
              <li>
          ...
          <section className='space-y-2'>
            ...
            <ul className='list-disc space-y-1 pl-5'>
              ...
              <li>
                Personal app activity associated with your account, including class
                reservations and workout records.
              </li>
              <li>Organization membership links associated with your user account.</li>
            </ul>
          </section>
          ...
          <section className='space-y-2'>
            ...
            <ul className='list-disc space-y-1 pl-5'>
              <li>
                Minimal security and legal compliance logs may be retained for up to{' '}
          ...
          <section className='space-y-2'>
            ...
            <p>
              ...
              <span className='font-medium'>30 days</span> after successful identity
              verification.
            </p>
          </section>
        </CardContent>
