        ...
        <CardContent className="space-y-6 text-base leading-7 text-zinc-800 dark:text-zinc-100">
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                Datos de perfil de cuenta (nombre, email y campos de perfil).
              </li>
              <li>
          ...
          <section className="space-y-2">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>
                Registros financieros, antifraude o legalmente requeridos solo
                por el plazo exigido por la normativa aplicable.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              <span className="font-medium">30 dias</span> despues de verificar
              la identidad.
            </p>
          </section>
        </CardContent>
