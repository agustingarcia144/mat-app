    ...
    return (
      <div className="border rounded-lg p-6 bg-muted/30">
        ...
        <div className="overflow-x-auto w-full">
          <div className="grid w-full min-w-[560px] grid-cols-7 gap-2">
        ...
        <div className="grid w-full min-w-[560px] grid-cols-7 gap-2">
          {DAY_NAMES.map(({ value: dow, label }) => {
            ...
            return (
              <div
                key={dow}
                className="flex min-h-[100px] max-h-[70vh] flex-col rounded-lg border bg-muted/20 p-2 overflow-hidden"
              >
