                        ...
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <AnimatedGroup
                                ...
                                <div
                                    ...
                                    <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] mix-blend-overlay bg-size-[16px_16px] [radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] dark:opacity-5"></div>
                                </div>
                            </AnimatedGroup>
                        </div>
                    </div>
            ...
            <div className="space-y-3">
                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        ...
                        <div className="flex h-5 items-center rounded bg-linear-to-l from-emerald-400 to-indigo-600 px-2 text-xs text-white">2024</div>
                    </div>
                    <div className="space-y-1">
                        <div className="space-x-1">
