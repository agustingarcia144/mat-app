...
export default function MetricsIndexScreen() {
  ...
  const cards: { label: string; icon: keyof typeof MaterialIcons.glyphMap; href: string; visible: boolean }[] = [
    {
      label: "Balance Financiero",
      icon: "bar-chart",
      href: "/(tabs)/more/metrics/payments",
      visible: isAdmin,
    },
    {
      label: "Métricas de Ejercicios",
      icon: "fitness-center",
      href: "/(tabs)/more/metrics/exercises",
      visible: true,
    },
  ];
