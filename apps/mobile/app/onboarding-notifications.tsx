  ...
  const handleEnable = async () => {
    ...
    try {
      ...
      if (!token || !platform) {
        setEnabled(false);
        setMessage(
          "No se pudieron activar. Podés habilitarlas después en Configuración.",
        );
        return;
      }
  ...
  return (
    ...
    >
      <View style={styles.bottomSection}>
        ...
        >
          Activá las notificaciones y te avisamos si se cancela una clase
          reservada, una hora antes de que empiece y cuando falte marcar
          asistencia.
        </Text>
