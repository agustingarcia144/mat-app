...
import { uploadAsync as uploadFileAsync } from "expo-file-system/legacy";
...
export default function ProofUploadForm() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Upload the file using FileSystem.uploadAsync to support
      // Android content:// URIs that fetch() cannot read
      const uploadResult = await uploadFileAsync(uploadUrl, selectedFile.uri, {
        httpMethod: "POST",
